...
we collected samples from the stream channel, DAWN (0500), MIDDAY (~1100/1200), DUSK (~1700), NIGHT (~2200)) , Color (i assigned a color based on 'Stream' or 'Well', i think black and blue), Period_Color (color associated with stream channel sampling 'DAWN', 'MIDDAY', 'DUSK', and 'NIGHT', i think its orange, black, blue, red, respectively). 
